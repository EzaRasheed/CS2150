...
class AVLTree {
 ...
 private:
  ...
  int numNodes(AVLNode* c) const;
  void insert(const string& x, AVLNode*& n);
  bool find(const string& x, AVLNode* n) const;
  string pathTo(const string& x, AVLNode* path_cur) const;
